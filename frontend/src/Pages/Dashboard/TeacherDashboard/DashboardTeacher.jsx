    ...
    <>
      <div className="m-5 ml-60 text-white flex flex-col gap-7">
        <div className="text-[1.1rem] w-[30rem] flex gap-60 items-center">
          ...
          <div className="bg-[#3B0F0F] p-3 rounded-md cursor-pointer">
            Details
          </div>
          <div
            // onClick={() => setPopup(true)}
            className="bg-[#3B0F0F] p-3 rounded-md cursor-pointer"
          >
            Remuneration
          </div>
        ...
        <div className="flex gap-32">
          <div className="flex flex-col gap-5">
            <p>Name :  <span className="text-white">{data.Firstname} {data.Lastname}</span></p>
            {/* <p>Name: {data.Firstname} {data.Lastname} {'⭐'.repeat(starCount)}</p> */}
            <p>Email :  <span className="text-white">{data.Email}</span></p>
            <p>Phone : <span className="text-white">{Tdec?.Phone}</span></p>
            <p>Address :  <span className="text-white">{Tdec?.Address}</span></p>
            <p>Experience :  <span className="text-white">{Tdec?.Experience} years</span></p>
          </div>
          <div>
            <div className="flex gap-3 flex-col">
              <p className="bg-[#3B0F0F] py-1 px-2 w-fit">Courses</p>
              {courses &&
