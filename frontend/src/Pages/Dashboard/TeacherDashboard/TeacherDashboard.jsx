    ...
    {/* navbar */}
      ...
      <div className='bg-[#2E2E2E] w-52 min-h-[120vh] max-h-[130vh] absolute top-20'>
        ...
        <div className='flex flex-col gap-1'>
          <NavLink to={`/Teacher/Dashboard/${ID}/Home`} className={({isActive}) => isActive ? "bg-white p-3 px-[4.61rem] text-center font-semibold text-[#C55C5C]" : "p-3 text-center font-semibold text-[#C55C5C]" }> 
          Dashboard
          </NavLink>

          <NavLink to={`/Teacher/Dashboard/${ID}/Classes`} className={({isActive}) => isActive ? "bg-white p-3 px-[4.61rem] text-center font-semibold text-[#C55C5C]" : "p-3 text-center font-semibold text-[#C55C5C]" }> 
          Classes
          </NavLink>

          <NavLink to={`/Teacher/Dashboard/${ID}/Courses`} className={({isActive}) => isActive ? "bg-white p-3 px-[4.61rem] text-center font-semibold text-[#C55C5C]" : "p-3 text-center font-semibold text-[#C55C5C]" }> 
          Courses
          </NavLink>
        </div>
      </div>
