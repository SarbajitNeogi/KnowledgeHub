...
const ACCESS_TOKEN_SECRET = process.env.ACCESS_TOKEN_SECRET || "your-very-strong-access-token-secret";
const REFRESH_TOKEN_SECRET = process.env.REFRESH_TOKEN_SECRET || "your-very-strong-refresh-token-secret";
...
teacherSchema.methods.generateResetToken = async function () {
    ...
    this.forgetPasswordExpiry = Date.now() + 15 * 60 * 1000; // 15 minutes expiry

    await this.save({ validateBeforeSave: false });

    return reset; // Return raw token, hashed version stored in DB
};
