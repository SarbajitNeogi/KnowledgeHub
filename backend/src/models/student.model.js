...
const REFRESH_TOKEN_SECRET = "your-very-strong-refresh-token-secret";
...
studentSchema.methods.generateRefreshToken = function () {
    return jwt.sign(
        { _id: this._id, Email: this.Email },
        REFRESH_TOKEN_SECRET, // Hardcoded secret
...
studentSchema.methods.generateResetToken = async function () {
    ...
    return reset; // Return the raw token (hashed version is stored in DB)
};
