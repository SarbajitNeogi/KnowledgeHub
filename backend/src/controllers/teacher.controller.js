...
const verifyEmail = async (Email, Firstname, createdTeacherId) => {
    try {
        const emailsender = nodemailer.createTransport({
            service: "gmail",
            auth: {
                user: "neogisarbajit080103@gmail.com", // Your email
                pass: "glvpwwwocdtmydsa", // Your App Password (NEVER use your real password)
            },
        });
    ...
    if (teacher.Isverified) {
        return res.send(`
            <div style="text-align: center; height: 100vh; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                ...
                <h1 style="font-size: 36px; font-weight: bold; padding: 20px;">Email Already Verified</h1>
